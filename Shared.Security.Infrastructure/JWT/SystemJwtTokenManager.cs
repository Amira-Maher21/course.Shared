...
{
    public class SystemJwtTokenManager : ISystemJwtTokenManger
    {
        ISystemUserManager _userManager;
        private readonly JwtOptions _jwtOptions;

        public SystemJwtTokenManager(ISecurityUnitOfWork commandManager, IOptions<JwtOptions> jwtOptions)
        {
            _userManager = commandManager.SystemUsers;
            _jwtOptions = jwtOptions.Value;
        }

        public async Task<ReturnBase<CreateTokenResultDto>> CreateTokenAsync(SystemLoginDto login)
        {
        ...
        private async Task<ReturnBase<CreateTokenResultDto>> generateToken(SystemUserDto user)
        {
        ...
        private async Task<List<Claim>> getClaims(SystemUserDto user)
        {
